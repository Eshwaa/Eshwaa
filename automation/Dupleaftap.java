package week4.day2;
	...
	public class Dupleaftap {
	    public static void main(String[] args) {
	                ...
	                driver.findElement(By.id("createLeadForm_companyName")).sendKeys("Kums Tech solutions");
	                driver.findElement(By.id("createLeadForm_firstName")).clear();
	                driver.findElement(By.id("createLeadForm_firstName")).sendKeys("rat");
	                driver.findElement(By.className("smallSubmit")).click();
